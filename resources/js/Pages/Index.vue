<template>
    <layout>
        <div class="text-2xl mt-6 ml-4 px-4">
            <span class="text-lime-600 mr-1">Hola</span
            ><span class="text-sky-600">Alan!</span>
        </div>
        <div class="p-10 -mr-30">
            <div class="flex justify-between">
                <div class="mt-6 -mr-20">
                    <img
                        width="600"
                        height="320"
                        src="https://www.advertisementshout.com/wp-content/uploads/2021/07/rick_astley_youtube_1627540038486.jpg"
                        alt="imagen increible"
                    />
                    <div class="bg-sky-600">
                        <div class="text-white px-2 py-1">Enlaces</div>
                        <div class="text-white -mt-5 px-2 py-2">Rápidos</div>
                    </div>

                    <div class="flex justify-center gap-6">
                        <div class="-mt-10 w-6 h-6">
                            <svg
                ...
                <div class="py-12 px-20">
                    <div class="bg-sky-600 ml-4">
                        <span
                            ><h3 class="text-white py-1 px-4">
                                Novedades
                            </h3></span
                        >
                    </div>
                    <div class="ml-6">
                        <div class="py-2">
                            <img
                                class="w-7 h-7"
                                src="https://learn.content.blackboardcdn.com/3900.39.0-rel.24+5903d92/images/ci/ng/default_profile_avatar.svg"
                            />
                            <div class="flex justify-end -mt-8">
                                <img
                                    width="300"
                                    height="400"
                                    src="https://i.ibb.co/y442HX5/botones.png"
                                />
                            </div>
                        </div>
                        <div class="py-2 px-3">
                    ...
                    <div class="flex justify-end -mr-12">
                        <div>
                            <img
                                width="550"
                                height="320"
                                src="https://i.ibb.co/JqNL0gG/inferior.png"
                                alt="imagen nada increible"
                            />
                        </div>
                    </div>
                </div>
